  ...
  return {
    ...
    commands: {
      area: {
        ...
        addNameAlias: frameworkify(commands.area.addNameAlias),
        removeNameAlias: frameworkify(commands.area.removeNameAlias),
      },
      equipment: {
        ...
        addNameAlias: frameworkify(commands.equipment.addNameAlias),
        removeNameAlias: frameworkify(commands.equipment.removeNameAlias),
      },
      trainers: {
        add: frameworkify(commands.trainers.add),
        remove: frameworkify(commands.trainers.remove),
